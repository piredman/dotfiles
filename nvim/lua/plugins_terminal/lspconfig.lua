    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>fy', require('telescope.builtin').lsp_document_symbols, '[F]ode S[y]mbols')
          ...
          map('<leader>cr', '<cmd>LspRestart<CR>', '[C]ode [R]estart Language Server')
